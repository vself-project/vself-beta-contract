...
sh.exec(
  `near call ${contractName} approve_admin '{"admin_id": "ilerik.testnet"}' --accountId ${ownerAccount} --gas 300000000000000`
);
sh.exec(`near view ${contractName} is_admin '{"admin_id": "ilerik.testnet"}'`); // should equal true
sh.exec(
  `near call ${contractName} revoke_admin '{"admin_id": "ilerik.testnet"}' --accountId ${ownerAccount} --gas 300000000000000`
);
sh.exec(`near view ${contractName} is_admin '{"admin_id": "ilerik.testnet"}'`); // should equal false
console.log("..................................");
...
if (!extractResultBoolean(res)) {
  ...
  sh.exec(`near call ${contractName} start_event '{"event": {
    ...
    "finish_time": ${
      new Date().getTime() * 1000000 + 30 * 24 * 60 * 60 * 1000000
    },
    "quests": [{
